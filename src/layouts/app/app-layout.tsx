...
export function AppLayout() {
  ...
  return <div className="min-h-screen bg-page text-ink lg:pl-[244px]">
    ...
    <header className="sticky top-0 z-10 flex h-[58px] items-center gap-3 border-b border-border bg-white px-5 shadow-sm sm:px-7"><h2 className="flex-1 text-[17px] font-semibold">{titles[pathname] ?? 'Europlate'}</h2><span className="rounded-md border border-border bg-[#f7f9fc] px-3 py-2 font-mono text-xs font-bold text-amber-600"><span className="mr-2 font-sans text-[11px] font-semibold text-slate-400">T.C. USD</span>3.40</span></header>
