...
export interface ProductBase { id: string; code: string; name: string; categoryId?: string | null; categoryName?: string | null; roles: ProductRole[]; status: ProductStatus; variantType: 'Con variantes' | 'Básico'; immediateConsumption?: boolean; attributes: Attribute[] }
