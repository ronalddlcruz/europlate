...
export interface ProductBase { id: string; code: string; name: string; roles: ProductRole[]; status: ProductStatus; variantType: 'Con variantes' | 'Básico'; immediateConsumption?: boolean; attributes: Attribute[] }
