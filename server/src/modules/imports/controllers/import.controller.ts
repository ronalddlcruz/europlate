...
export const importController = {
  ...
  async catalog(request: Request, response: Response) { const [suppliers, customsAgents, products, warehouses, variableSubcategories] = await importService.catalog(request.auth!.companyId); response.json({ data: { suppliers, customsAgents, products, warehouses, variableSubcategories } }) },
